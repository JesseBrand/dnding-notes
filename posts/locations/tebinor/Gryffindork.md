...
## Compound
The compound consists of two buildings. A two-story stone building contains a [[Smith's Tools|Smithy]] on the ground floor and a [[Brewer's Supplies|Brewery]] on the second floor.  A two-story wooden building serves as living and sleeping quarters. In between a smaller storehouse provides room for Barrels of [[Ale]] and other supplies to be stored.
...
When completed, the bottom floor will house the [[Smith's Tools|Smithy]] where multiple smiths can practice their crafts. The second floor will contains a [[Brewer's Supplies|Brewery]] with multiple stills. It will be connected to the storehouse in between the buildings, where the barrels of ale can be stored.
